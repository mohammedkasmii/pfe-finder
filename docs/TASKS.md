...
| M3 | Search and offer experience | Claude | M2 | READY | Validated cursor API, filters in URL, offer list/detail pages, local favorites, bilingual states, freshness display, rate limiting, and component/API tests pass. |
