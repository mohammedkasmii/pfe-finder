...
| M2 | Database and ingestion | Claude | M1 | READY | Reproducible Supabase migrations/RLS, adapter contract, three configured sources, classification fixtures, safe URL/text normalization, idempotent upsert, complete-scan semantics, and collector tests pass. |
